...
const relistProduct = async (page,$options) =>{
    ...
    await page.waitForSelector('#main > div > div.listing-wrapper > div > div > div.user-home.fjb.clearfix > div.col-xs-10.bar0 > div > div.block__box__container > div:nth-child(6) > div > div > div.pull-right > div > ul > li > a');
    const clickAktif = await page.$('#main > div > div.listing-wrapper > div > div > div.user-home.fjb.clearfix > div.col-xs-10.bar0 > div > div.block__box__container > div:nth-child(6) > div > div > div.pull-right > div > ul > li > a');
